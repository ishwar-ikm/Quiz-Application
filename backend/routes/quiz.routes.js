...
import { createQuiz, deleteQuiz, getAllQuiz, getCreatedQuestion, getFeedback, getOneQuiz, getQuestions, postFeedback } from "../controllers/quiz.controllers.js";
...
router.get("/createdQuestion/:quizId", protectRoute, getCreatedQuestion);
